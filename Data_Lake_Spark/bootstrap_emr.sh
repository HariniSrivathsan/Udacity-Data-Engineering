...
aws s3 cp s3://harini-spark-emr/bootstraps $HOME/bootstraps --recursive

# make sure Python3 is the env spark runs on.
...
export PATH=$PATH:/home/hadoop/apache-livy-0.7.0-incubating-bin/bin
' >> $HOME/.profile
